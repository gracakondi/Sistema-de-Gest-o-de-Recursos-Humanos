...
Nome: Gildo Kondi
Numero: 33049
Ficheiro: EliminarDepartamentoVisao.java
Data: 14.06.2024
--------------------------------------*/
...
public class EliminarDepartamentoVisao extends JFrame
{	
	
	PainelCentro centro;
	PainelSul sul;
	
	public EliminarDepartamentoVisao()
	{
			...
			if (evt.getSource() == pesquisarJB)
			{
				...
				if (centro.getTipoPesquisa() == 1)
				{
					...
					if (opcao == JOptionPane.YES_OPTION)
					{
						...
						modelo.setStatusDept(false);
						
						new DepartamentoFile().eliminarDados( modelo );
					}
					else
